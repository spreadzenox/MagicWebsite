 ...
 */
class getPaquetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaquetRepository' shared autowired service.
     *
     * @return \App\Repository\PaquetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaquetRepository.php';

        return $container->privates['App\\Repository\\PaquetRepository'] = new \App\Repository\PaquetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
