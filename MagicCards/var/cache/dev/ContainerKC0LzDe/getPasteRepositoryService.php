 ...
 */
class getPasteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PasteRepository' shared autowired service.
     *
     * @return \App\Repository\PasteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PasteRepository.php';

        return $container->privates['App\\Repository\\PasteRepository'] = new \App\Repository\PasteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
